...
<div id="comments" class="comments-area">
    ...
    <?php if (have_comments()) : ?>
        <h4 class="comments-title widget-title">
            <?php
            printf(// WPCS: XSS OK.
                    esc_html(_nx('%d Comment', '%d Comments', get_comments_number(), 'comments title', 'viral-pro')), number_format_i18n(get_comments_number())
            );
            ?>
        </h4>
    ...
    $fields = array(
        ...
        '" size="30"' . $aria_req . ' placeholder="' . esc_attr__('Name', 'viral-pro') . ( $req ? '*' : '' ) . '" /></p>',
        'email' =>
