...
(function ($) {
    ...
    wp.customize('viral_pro_mh_header_bg_url', function (value) {
        value.bind(function (to) {
            var overlay = wp.customize('viral_pro_mh_header_bg_overlay').get();
    ...
    wp.customize('viral_pro_mh_header_bg_color', function (value) {
        value.bind(function (to) {
            var css = '.ht-header-two, .ht-header-four, .ht-header-five, .ht-header-seven{background-color:' + to + '}';
            viral_pro_dynamic_css('viral_pro_mh_header_bg_color', css);
        });
    });

    wp.customize('viral_pro_mh_header_bg_overlay', function (value) {
        value.bind(function (to) {
            var css = '.ht-header-two:before, .ht-header-four:before, .ht-header-five:before, .ht-header-seven:before{background-color:' + to + '}';
            viral_pro_dynamic_css('viral_pro_mh_header_bg_overlay', css);
        });
    });

    wp.customize('viral_pro_website_width', function (value) {
        value.bind(function (container_width) {
            var container_padding = wp.customize('viral_pro_container_padding').get();
            var full_container_padding = wp.customize('viral_pro_container_padding').get() * 2;
    ...
    wp.customize('viral_pro_fluid_container_width', function (value) {
        value.bind(function (container_width) {
            var css = 'body.ht-fluid .ht-container,body.ht-fluid .ht-slide-caption{max-width:' + container_width + '%}';
            viral_pro_dynamic_css('viral_pro_fluid_container_width', css);
        });
    });

    wp.customize('viral_pro_container_padding', function (value) {
        value.bind(function (container_padding) {
            var container_width = wp.customize('viral_pro_website_width').get();
            var boxed_container_width = parseInt(container_width) + parseInt(container_padding) * 2;
            var css = '.ht-container,.ht-slide-caption{max-width:' + container_width + 'px}';
            css += 'body.ht-boxed #ht-page{max-width:' + boxed_container_width + 'px;}';
            css += 'body.ht-boxed .ht-fullwidth-container, body.ht-boxed .vl-fwcarousel-block{margin-left:-' + container_padding + 'px !important;margin-right:-' + container_padding + 'px !important;}';
            viral_pro_dynamic_css('viral_pro_container_padding', css);
        });
    });
            ...
            function (value) {
                value.bind(
                        function (to) {
                            ...
                            var css = '.ht-site-title-tagline .ht-site-title{font-weight:' + weight + ';font-style:' + style + '}';
                            viral_pro_dynamic_css('title_font_style', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-title{text-transform:' + to + '}';
                            viral_pro_dynamic_css('title_text_transform', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-title{text-decoration:' + to + '}';
                            viral_pro_dynamic_css('title_text_decoration', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-main-navigation, .ht-site-title-tagline .ht-site-title{font-size:' + to + 'px}';
                            viral_pro_dynamic_css('title_font_size', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-title{line-height:' + to + '}';
                            viral_pro_dynamic_css('title_line_height', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-title{letter-spacing:' + to + 'px}';
                            viral_pro_dynamic_css('title_letter_spacing', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-title{color:' + to + '}';
                            viral_pro_dynamic_css('title_color', css);
                        }
                );
            }
    );
            ...
            function (value) {
                value.bind(
                        function (to) {
                            ...
                            var css = '.ht-site-title-tagline .ht-site-description{font-weight:' + weight + ';font-style:' + style + '}';
                            viral_pro_dynamic_css('tagline_font_style', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-description{text-transform:' + to + '}';
                            viral_pro_dynamic_css('tagline_text_transform', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            'tagline_text_decoration',
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-description{text-decoration:' + to + '}';
                            viral_pro_dynamic_css('tagline_text_decoration', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-main-navigation, .ht-site-title-tagline .ht-site-description{font-size:' + to + 'px}';
                            viral_pro_dynamic_css('tagline_font_size', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-description{line-height:' + to + '}';
                            viral_pro_dynamic_css('tagline_line_height', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-description{letter-spacing:' + to + 'px}';
                            viral_pro_dynamic_css('tagline_letter_spacing', css);
                        }
                );
            }
    );
    ...
    wp.customize(
            ...
            function (value) {
                value.bind(
                        function (to) {
                            var css = '.ht-site-title-tagline .ht-site-description{color:' + to + '}';
                            viral_pro_dynamic_css('tagline_color', css);
                        }
                );
            }
    );
