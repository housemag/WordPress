...
$wp_customize->add_control(new Viral_Pro_Tab_Control($wp_customize, 'viral_pro_maintenance_nav', array(
    'section' => 'viral_pro_maintenance_section',
    'priority' => 1,
    'buttons' => array(
        array(
...
$wp_customize->add_control(new Viral_Pro_Image_Selector_Control($wp_customize, 'viral_pro_maintenance_layout', array(
    'section' => 'viral_pro_maintenance_section',
    'label' => esc_html__('Maintenance Layout', 'viral-pro'),
    'image_path' => VIRAL_PRO_CUSTOMIZER_URL . 'customizer-panel/images/maintenance/',
    'image_type' => 'png',
    'choices' => array(
...
$wp_customize->add_control(new Viral_Pro_Editor_Control($wp_customize, 'viral_pro_maintenance_text', array(
    'section' => 'viral_pro_maintenance_section',
...
$wp_customize->add_control(new Viral_Pro_Text_Info_Control($wp_customize, 'viral_pro_maintenance_social', array(
...
$wp_customize->add_control(new Viral_Pro_Background_Image_Control($wp_customize, "viral_pro_maintenance_banner", array(
    ...
    'settings' => array(
        ...
        'attachment' => "viral_pro_maintenance_banner_image_attach"
    ),
)));
...
$wp_customize->add_control(new Viral_Pro_Repeater_Control($wp_customize, 'viral_pro_maintenance_sliders', array(
...
$wp_customize->add_control(new Viral_Pro_Text_Info_Control($wp_customize, 'viral_pro_maintenance_slider_info', array(
    'section' => 'viral_pro_maintenance_section',
...
$wp_customize->add_control(new Viral_Pro_Range_Slider_Control($wp_customize, 'viral_pro_maintenance_slider_pause', array(
    'section' => 'viral_pro_maintenance_section',
