...
/** Repeater Control */
class Viral_Pro_Custom_Repeater_Control extends WP_Customize_Control {
                ...
                <div class="ht--custom-repeater-fields">
                        ...
                        <div class="ht--fields ht--type-<?php echo esc_attr($field['type']) . ' ' . esc_attr($class); ?>">
                            ...
                            switch ($field['type']) {
                                ...
                                case 'upload':
                                    ...
                                    echo '<button type="button" class="button ht--delete-button align-left">' . esc_html__('Remove', 'viral-pro') . '</button>';
                                    echo '<button type="button" class="button ht--upload-button alignright">' . esc_html__('Select Image', 'viral-pro') . '</button>';
                    ...
                    <div class="ht--clearfix ht--custom-repeater-footer">
                        <div class="alignright">
                            <a class="ht--custom-repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'viral-pro') ?></a> |
                            <a class="ht--custom-repeater-field-close" href="#close"><?php esc_html_e('Close', 'viral-pro') ?></a>
                        </div>
                    </div>
                </div>
            </li>
