...
/** Repeater Control */
class Viral_Pro_Repeater_Control extends WP_Customize_Control {
                    ...
                    <div class="ht--repeater-fields">
                        ...
                        <div class="ht--clearfix ht--repeater-footer">
                            <div class="alignright">
                                <a class="ht--repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'viral-pro') ?></a> |
                                <a class="ht--repeater-field-close" href="#close"><?php esc_html_e('Close', 'viral-pro') ?></a>
                            </div>
                        </div>
                    </div>
                </li>
