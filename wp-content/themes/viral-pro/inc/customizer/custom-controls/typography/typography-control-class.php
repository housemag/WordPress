...
class Viral_Pro_Typography_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->l10n = wp_parse_args(
            ...
            'color' => esc_html__('Font Color', 'viral-pro')
                )
        );
    }
    ...
    public function enqueue() {
        wp_enqueue_script('ht--customize-typograhpy-controls', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/typography/js/customize-controls.js', array('jquery'), VIRAL_PRO_VER, true);
        wp_enqueue_style('ht--customize-typograhpy-controls', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/typography/css/customize-controls.css', array(), VIRAL_PRO_VER);
    }
    ...
    public function get_registered_fonts() {
        return viral_pro_register_fonts();
    }
    ...
    public function get_font_weight_choices() {
        ...
        return array(
            ...
            '400italic' => esc_html__('Normal Italic', 'viral-pro'),
            '700' => esc_html__('Bold', 'viral-pro'),
            '700italic' => esc_html__('Bold Italic', 'viral-pro')
        );
    }
