...
/** Color Tab Control */
class Viral_Pro_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'viral-pro'),
            'x' => esc_attr__('X', 'viral-pro'),
            'y' => esc_attr__('Y', 'viral-pro'),
            'blur' => esc_attr__('Blur', 'viral-pro'),
            'spread' => esc_attr__('Spread', 'viral-pro'),
            'inset' => esc_attr__('Inset', 'viral-pro'),
            'color' => esc_attr__('Color', 'viral-pro'),
        );
        if (false === $id) {
