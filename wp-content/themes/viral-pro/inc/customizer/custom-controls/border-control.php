...
/** Border Control */
class Viral_Pro_Border_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'border_width' => esc_attr__('Width', 'viral-pro'),
            'border_type' => esc_attr__('Border Type', 'viral-pro'),
            'color' => esc_attr__('Border Color', 'viral-pro'),
            'top' => esc_attr__('Top', 'viral-pro'),
            'right' => esc_attr__('Right', 'viral-pro'),
            'bottom' => esc_attr__('Bottom', 'viral-pro'),
            'left' => esc_attr__('Left', 'viral-pro')
        );
        if (false === $id) {
        ...
        <ul>
            ...
            <li class="ht--border-color">
                ...
                <div class="customize-control-content">
                    <input class="ht--color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e('Hex Value', 'viral-pro'); ?>" {{{ data.color.link }}} value="{{ data.color.value }}"  />
                </div>
            </li>
            <# } #>
    ...
    function get_all_border_types() {
        return array(
            '' => esc_attr__('None', 'viral-pro'),
            'solid' => esc_attr__('Solid', 'viral-pro'),
            'double' => esc_attr__('Double', 'viral-pro'),
            'dotted' => esc_attr__('Dotted', 'viral-pro'),
            'dashed' => esc_attr__('Dashed', 'viral-pro'),
            'groove' => esc_attr__('Groove', 'viral-pro')
        );
    }
