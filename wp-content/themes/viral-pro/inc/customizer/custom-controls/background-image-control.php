...
/** Background Control */
class Viral_Pro_Background_Image_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->button_labels = apply_filters('viral_pro_customizer_background_button_labels', $button_labels, $id);

        // Set field labels
        $field_labels = $this->get_field_labels();
        $this->field_labels = apply_filters('viral_pro_customizer_background_field_labels', $field_labels, $id);

        // Set background choices
        $background_choices = $this->get_background_choices();
        $this->background_choices = apply_filters('viral_pro_customizer_background_choices', $background_choices, $id);
    }
    ...
    public static function get_field_labels() {
        ...
        $field_labels = array(
            ...
            'attachment' => esc_html__('Attachment', 'viral-pro'),
            'color' => esc_html__('Background Color', 'viral-pro'),
            'overlay' => esc_html__('Overlay Color', 'viral-pro')
        );
