...
class Viral_Pro_Gradient_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('color-picker', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/assets/js/colorpicker.js', array('jquery'), VIRAL_PRO_VER, true);
        wp_enqueue_script('jquery-classygradient', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/assets/js/jquery.classygradient.js', array('jquery'), VIRAL_PRO_VER, true);
        wp_enqueue_script('custom-gradient', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/assets/js/custom-gradient.js', array('jquery', 'jquery-ui-slider'), VIRAL_PRO_VER, true);

        wp_enqueue_style('color-picker', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/assets/css/colorpicker.css');
        wp_enqueue_style('jquery-classygradient', VIRAL_PRO_CUSTOMIZER_URL . 'custom-controls/assets/css/jquery.classygradient.css');
    }
        ...
        <div class="ht--gradient-box" data-default-color="<?php echo esc_attr($default_color); ?>">
            ...
            <div class="ht--gradient-row">
                ...
                <select class="ht--gradient-direction">
                    <option value="vertical"><?php echo esc_html__('Vertical Spread (Top to Bottom)', 'viral-pro'); ?></option>
                    <option value="horizontal"><?php echo esc_html__('Horizontal Spread (Left To Right)', 'viral-pro'); ?></option>
                    <option value="custom"><?php echo esc_html__('Custom Angle Spread', 'viral-pro'); ?></option>
                </select>
            </div>

            <div class="ht--gradient-row">
                <div class="ht--gradient-custom" style="display: none;">
                    <div class="ht--gradient-label"><?php echo esc_html__('Define Custom Angle', 'viral-pro'); ?></div>
