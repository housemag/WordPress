 ...
 * @package Viral Pro
 */
add_action('widgets_init', 'viral_pro_register_post_carousel');

function viral_pro_register_post_carousel() {
    register_widget('viral_pro_post_carousel');
}

class viral_pro_post_carousel extends WP_Widget {

    public function __construct() {
        $widget_ops = array('description' => __('A widget to display latest, most commented, most viewed post with thumbnail.', 'viral-pro'));
        parent::__construct('viral_pro_post_carousel', '&bull; VP : Post Carousel', $widget_ops);
    }
