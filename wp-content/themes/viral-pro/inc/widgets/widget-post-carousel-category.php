 ...
 * @package Viral Pro
 */
add_action('widgets_init', 'viral_pro_register_category_post_carousel');

function viral_pro_register_category_post_carousel() {
    register_widget('viral_pro_category_post_carousel');
}

class viral_pro_category_post_carousel extends WP_Widget {

    public function __construct() {
        $widget_ops = array('description' => __('A widget to display category post with thumbnail.', 'viral-pro'));
        parent::__construct('viral_pro_category_post_carousel', '&bull; VP : Post Carousel by Category', $widget_ops);
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'thumbnail_size' => array(
                ...
                'viral_pro_widgets_default' => 'viral-pro-500x500'
            ),
            'display_date' => array(
    ...
    public function widget($args, $instance) {
        ...
        $thumbnail_size = isset($instance['thumbnail_size']) ? $instance['thumbnail_size'] : 'viral-pro-500x500';
        ...
        ?>
        <?php echo viral_pro_is_amp() ? '<amp-carousel class="amp-slider ht-post-carousel" width="390" height="250" layout="responsive" type="slides" delay="3500">' : '<div class="ht-post-carousel owl-carousel">'; ?>
        <?php
        $args = array(
            'post_type' => 'post',
        ...
        while ($query->have_posts()) : $query->the_post();
            ...
            <div class="ht-post-slide">
                ...
                <div class="ht-pl-content <?php echo viral_pro_is_amp() ? 'vl-post-content vl-gradient-overlay' : ''; ?>">
