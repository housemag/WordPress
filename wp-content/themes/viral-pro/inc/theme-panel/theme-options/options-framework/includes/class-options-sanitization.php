...
function of_recognized_background_repeat() {
    $default = array(
        'no-repeat' => __('No Repeat', 'viral-pro'),
        'repeat-x' => __('Repeat Horizontally', 'viral-pro'),
        'repeat-y' => __('Repeat Vertically', 'viral-pro'),
        'repeat' => __('Repeat All', 'viral-pro'),
    );
...
function of_recognized_background_position() {
    $default = array(
        'top left' => __('Top Left', 'viral-pro'),
        'top center' => __('Top Center', 'viral-pro'),
        'top right' => __('Top Right', 'viral-pro'),
        'center left' => __('Middle Left', 'viral-pro'),
        'center center' => __('Middle Center', 'viral-pro'),
        'center right' => __('Middle Right', 'viral-pro'),
        'bottom left' => __('Bottom Left', 'viral-pro'),
        'bottom center' => __('Bottom Center', 'viral-pro'),
        'bottom right' => __('Bottom Right', 'viral-pro')
    );
...
function of_recognized_background_attachment() {
    $default = array(
        'scroll' => __('Scroll Normally', 'viral-pro'),
        'fixed' => __('Fixed in Place', 'viral-pro')
    );
...
function of_recognized_font_styles() {
    $default = array(
        ...
        'italic' => __('Italic', 'viral-pro'),
        'bold' => __('Bold', 'viral-pro'),
        'bold italic' => __('Bold Italic', 'viral-pro')
    );
