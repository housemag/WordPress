...
$header_class = array('ht-site-header', 'ht-header-four', $viral_pro_mh_menu_hover_style, $viral_pro_tagline_position, $viral_pro_mh_border);
...
<header id="ht-masthead" class="<?php echo esc_attr(implode(' ', $header_class)); ?>" <?php echo viral_pro_get_schema_attribute('header'); ?>>
    ...
    <div class="ht-middle-header">
        <div class="ht-container">
            ...
            <?php if (is_active_sidebar('viral-pro-header-widget')) { ?>
                <div class="ht-header-widget">
                    <?php dynamic_sidebar('viral-pro-header-widget'); ?>
                </div>
            <?php } ?>
        </div>
    </div>
