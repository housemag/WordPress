...
$header_class = array('ht-site-header', 'ht-header-seven', $viral_pro_mh_menu_hover_style, $viral_pro_tagline_position, $viral_pro_mh_border);
    ...
    <div class="ht-header">
        <div class="ht-container">   
            <div class="ht-left-buttons">
                <div class="ht-offcanvas-nav" <?php echo viral_pro_amp_offcanvas_nav_toggle(); ?>>
                    <?php
