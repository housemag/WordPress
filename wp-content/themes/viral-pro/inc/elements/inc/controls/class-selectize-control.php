...
class Selectize_Control extends Base_Data_Control {
    ...
    const Selectize = 'viral-pro-selectize';
    ...
    public function enqueue() {
        wp_enqueue_script('selectize', get_template_directory_uri() . '/inc/elements/assets/js/selectize.js', array('jquery', 'jquery-ui-sortable'), '1.0', true);
        wp_enqueue_script('custom-selectize', get_template_directory_uri() . '/inc/elements/assets/js/custom-selectize.js', array('selectize'), '1.0', true);
        wp_enqueue_style('selectize', get_template_directory_uri() . '/inc/elements/assets/css/selectize.css', array(), '');
    }
