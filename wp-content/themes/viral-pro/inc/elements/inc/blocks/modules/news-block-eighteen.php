...
class Viral_Pro_News_Block_Eighteen extends Viral_Pro_Posts_Block {
                    ...
                    <div class="vl-post-thumb">
                        <a href="<?php echo $source->get_permalink(); ?>">
                            <div class="vl-thumb-container">
                                <?php echo $source->get_featured_image($settings['featured_post_image_size']); ?>
                            </div>
                        </a>
                        <?php
            ...
            <?php if ($index == 2) { ?>
                ...
                <div class="vl-post-item ht-clearfix vp-module <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
                    <div class="vl-post-thumb">
                        <a href="<?php echo $source->get_permalink(); ?>">
                            <div class="vl-thumb-container">
                                <?php echo $source->get_featured_image($settings['side_post_image_size']); ?>
                            </div>
                        </a>
                        <?php
