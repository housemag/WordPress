...
class Viral_Pro_Tile_Block_One extends Viral_Pro_Posts_Block {
    ...
    protected function get_settings_data_atts() {
        ...
        $data_atts['large_side_post_image_size'] = $settings['large_side_post_image_size'];
    ...
    public function inner($posts, $settings) {
        ...
        $output = '';
        $output .= '<div class="vl-tile-block ht-clearfix style1 ' . esc_attr($gap) . '">';
        if (!empty($posts)) {
    ...
    public function render_content($settings) {
        ...
        if ($index == 1) {
            ?>
            <div class="vl-width-50 vl-height-100 vl-thumb vl-left-col">
            ...
            if ($index == 2)
                echo '<div class="vl-width-50 vl-height-100 vl-parent vl-right-col">';
            if ($index == 2) {
                ?>
                <div class="vl-width-100 vl-height-50 vl-thumb">
                    <div class="vl-thumb-inner vl-post-thumb vp-module <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
                        <a href="<?php echo $source->get_permalink(); ?>">
                            <?php echo $source->get_featured_image($side_large_image_size); ?>
                        </a>
            ...
            <?php if ($index > 2) { ?>
                <div class="vl-width-50 vl-height-50 vl-thumb">
                    <div class="vl-thumb-inner vl-post-thumb vp-module <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
                        ...
                        <div class="vl-title-container <?php echo esc_attr($content_align_class); ?>">
                            <a href="<?php echo $source->get_permalink(); ?>">
                                <h3 class="vl-post-title"><span><?php echo $source->get_title(); ?></span></h3>
                                <?php $this->get_post_meta($settings, $index) ?>
                            </a>
                        </div>
                    </div>
