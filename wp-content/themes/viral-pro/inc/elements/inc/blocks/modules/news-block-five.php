...
class Viral_Pro_News_Block_Five extends Viral_Pro_Posts_Block {
    ...
    public function inner($posts, $settings) {
        $output = '';
        $output .= '<div class="vl-news-block style1">';
        $output .= '<div class="vl-news-block-wrap">';
        if (!empty($posts)) {
                ...
                <div class="vl-post-item ht-clearfix vp-module <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
                    <div class="vl-post-thumb">
                        ...
                        if ($settings['featured_post_category'] == 'yes')
                            echo $source->get_primary_category('vl-primary-cat-block');
                        ?>
                    </div>

                    <div class="vl-post-content">
                        <h3 class="vl-big-title vl-post-title"><a href="<?php echo $source->get_permalink(); ?>"><?php echo $source->get_title(); ?></a></h3>
                        <?php echo $this->get_post_meta($settings, $index); ?>
                        <?php echo $this->get_post_excerpt($settings, $index); ?>
                    </div>
                </div>  
            </div>
            <?php
                ...
                <div class="vl-post-item ht-clearfix vp-module <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
                    <div class="vl-post-thumb">
                        <a href="<?php echo $source->get_permalink(); ?>">
                            <div class="vl-thumb-container">
                                <?php
                                echo $source->get_featured_image($listing_post_image_size);
                                ?>
                            </div>
                        </a>
                    </div>
