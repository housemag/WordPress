...
class Viral_Pro_News_Block_Fifteen extends Viral_Pro_Posts_Block {
    ...
    protected function get_settings_data_atts() {
        ...
        $data_atts['column_count_tablet']['size'] = isset($settings['column_count_tablet']['size']) ? $settings['column_count_tablet']['size'] : 1;
    ...
    public function inner($posts, $settings) {
        $column_count_tablet = isset($settings['column_count_tablet']['size']) ? $settings['column_count_tablet']['size'] : 1;
