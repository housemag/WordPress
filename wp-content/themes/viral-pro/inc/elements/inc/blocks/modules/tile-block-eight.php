...
class Viral_Pro_Tile_Block_Eight extends Viral_Pro_Posts_Block {
    ...
    public function inner($posts, $settings) {
        ...
        $output = '';
        $output .= '<div class="vl-tile-block ht-clearfix style8 ' . esc_attr($gap) . '">';
        if (!empty($posts)) {
    ...
    public function render_content($settings) {
        ...
        ob_start();
        if ($index == 1) {
            echo '<div class="vl-width-65 vl-height-100 vl-parent vl-left-col">';
        }

        if ($index == 2) {
            echo '<div class="vl-width-35 vl-height-100 vl-parent vl-right-col">';
        }
        ?>  
