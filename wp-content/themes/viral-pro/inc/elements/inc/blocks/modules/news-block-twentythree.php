...
class Viral_Pro_News_Block_Twentythree extends Viral_Pro_Posts_Block {
    ...
    protected function get_settings_data_atts() {
        ...
        $data_atts['excerpt_length'] = $settings['excerpt_length'];
    ...
    public function inner($posts, $settings) {
        $output = '';
        $output .= '<div class="vl-grid-6-block">';
        if (!empty($posts)) {
    ...
    public function render_content($settings) {
        ...
        <div class="vl-post-item ht-clearfix vp-module <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
            <div class="vl-post-thumb">
                ...
                <?php if ($display_cat == 'yes') echo $source->get_primary_category(); ?>
            </div>
