...
class Viral_Pro_Tile_Block_Four extends Viral_Pro_Posts_Block {
    ...
    public function inner($posts, $settings) {
        ...
        $output = '';
        $output .= '<div class="vl-tile-block ht-clearfix style4 ' . esc_attr($gap) . '">';
        if (!empty($posts)) {
    ...
    public function render_content($settings) {
        ...
        if ($index == 1) {
            ?>
            <div class="vl-width-65 vl-height-100 vl-thumb vl-left-col">
