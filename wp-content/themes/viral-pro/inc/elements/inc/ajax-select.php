...
class Ajax_Select {
    ...
    public function __construct() {
        add_action('wp_ajax_viral_pro_get_posts_by_query', array($this, 'get_posts_by_query'));
        add_action('wp_ajax_nopriv_viral_pro_get_posts_by_query', array($this, 'get_posts_by_query'));
        add_action('wp_ajax_viral_pro_get_posts_title_by_id', array($this, 'get_posts_title_by_id'));
        add_action('wp_ajax_nopriv_viral_pro_get_posts_title_by_id', array($this, 'get_posts_title_by_id'));
    }
