...
namespace Viral_Pro_Elements\Modules\TileModuleThree\Widgets;
...
class TileModuleThree extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module 3', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-three vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style3' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_three';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_three');
