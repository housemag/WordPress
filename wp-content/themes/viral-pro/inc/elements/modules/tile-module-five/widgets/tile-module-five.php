...
namespace Viral_Pro_Elements\Modules\TileModuleFive\Widgets;
 ...
 * Tiled Posts Widget
 */
class TileModuleFive extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module 5', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-five vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style5' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-post-title span',
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_five';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_five');
