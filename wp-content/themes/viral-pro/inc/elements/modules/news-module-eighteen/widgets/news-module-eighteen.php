...
namespace Viral_Pro_Elements\Modules\NewsModuleEighteen\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleEighteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 18', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-eighteen vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-1-2-block .vl-small-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
                Group_Control_Typography::get_type(), [
            'name' => 'listing_post_title_typography',
            'label' => esc_html__('Typography', 'viral-pro'),
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_eighteen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_eighteen');
