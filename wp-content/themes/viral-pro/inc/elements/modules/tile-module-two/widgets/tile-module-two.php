...
namespace Viral_Pro_Elements\Modules\TileModuleTwo\Widgets;
...
class TileModuleTwo extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module 2', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-two vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style2' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_two';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_two');
