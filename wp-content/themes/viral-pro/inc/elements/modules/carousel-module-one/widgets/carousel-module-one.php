...
namespace Viral_Pro_Elements\Modules\CarouselModuleOne\Widgets;
...
class CarouselModuleOne extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Carousel Module 1', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-carousel-module-one vp-elementor-icon';
    }
    ...
    protected function render() {
        ...
        <div class="vl-carousel-block style1 <?php echo esc_attr($settings['image_hover_style']); ?>">
