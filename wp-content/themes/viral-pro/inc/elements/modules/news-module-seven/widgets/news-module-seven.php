...
namespace Viral_Pro_Elements\Modules\NewsModuleSeven\Widgets;
...
class NewsModuleSeven extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 7', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-seven vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-post-thumb' => 'width: {{SIZE}}{{UNIT}}',
                '{{WRAPPER}} .vl-small-block .vl-post-content' => 'margin-left: calc({{SIZE}}{{UNIT}} + 20px)',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-primary-cat,
                 {{WRAPPER}} .vl-category' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-primary-cat,
                 {{WRAPPER}} .vl-category' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-primary-cat:hover,
                 {{WRAPPER}} .vl-category:hover' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-primary-cat:hover,
                 {{WRAPPER}} .vl-category:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-post-title, 
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-post-title:hover, 
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_seven';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_seven');
