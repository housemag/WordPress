...
namespace Viral_Pro_Elements\Modules\CarouselModuleFive\Widgets;
 ...
 * Tiled Posts Widget
 */
class CarouselModuleFive extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Carousel Module 5', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-carousel-module-five vp-elementor-icon';
    }
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-carousel-block style5 <?php echo esc_attr($settings['image_hover_style']); ?>">
