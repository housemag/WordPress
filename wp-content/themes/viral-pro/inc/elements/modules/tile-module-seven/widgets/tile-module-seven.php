...
namespace Viral_Pro_Elements\Modules\TileModuleSeven\Widgets;
 ...
 * Tiled Posts Widget
 */
class TileModuleSeven extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module 7', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-seven vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style7' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-featured-post .vl-post-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-featured-post .vl-post-title span' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-side-post .vl-post-title span',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-side-post .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_seven';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_seven');
