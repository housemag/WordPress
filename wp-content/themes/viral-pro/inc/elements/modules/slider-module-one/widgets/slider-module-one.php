...
namespace Viral_Pro_Elements\Modules\SliderModuleOne\Widgets;
 ...
 * Tiled Posts Widget
 */
class SliderModuleOne extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Slider Module 1', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-slider-module-one vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style1 .vl-title-wrap' => 'width: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style1 .slide-item h3 a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style1 .slide-item h3 a:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-slider-block.style1 .slide-item h3 a',
                ]
        );
