...
namespace Viral_Pro_Elements\Modules\SingleNewsOne\Widgets;
...
class Single_News_One extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single News One', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-elementor-icon vp-single-news-one';
    }
            ...
            if ($post_query->have_posts()) {
                ...
                <div class="vl-single-post-one">
                    ...
                    while ($post_query->have_posts()) {
                        ...
                        <div class="vl-post-content <?php echo $settings['content_alignment']; ?>">
