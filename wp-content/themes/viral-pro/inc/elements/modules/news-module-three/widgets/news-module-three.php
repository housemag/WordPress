...
namespace Viral_Pro_Elements\Modules\NewsModuleThree\Widgets;
...
class NewsModuleThree extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 3', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-three vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => ['{{WRAPPER}} .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}'],
                ]
        );

        $this->add_control('side_excerpt_length', [
            'label' => esc_html__('Excerpt Length', 'viral-pro'),
            'description' => esc_html__('Enter 0 to hide excerpt', 'viral-pro'),
            'type' => Controls_Manager::NUMBER,
            'min' => 0,
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .vl-primary-cat-block .vl-primary-cat,
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-post-categories li a.vl-category,
                 {{WRAPPER}} .vl-primary-cat-block .vl-primary-cat' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-post-categories li a.vl-category,
                 {{WRAPPER}} .vl-primary-cat-block .vl-primary-cat' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-categories li a.vl-category:hover,
                 {{WRAPPER}} .vl-primary-cat-block .vl-primary-cat:hover' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-post-categories li a.vl-category:hover,
                 {{WRAPPER}} .vl-primary-cat-block .vl-primary-cat:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col1 .vl-post-content h3.vl-post-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Side Post Title Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col2 .vl-post-content h3.vl-post-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Side Post Title Color (Hover)', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col2 .vl-post-content h3.vl-post-title:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .col1 .vl-post-content h3.vl-post-title span',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .col1 .vl-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .col2 .vl-post-content h3.vl-post-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .col2 .vl-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col1 .vl-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
                'side_excerpt_color', [
            'label' => esc_html__('Side Post Excerpt Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col2 .vl-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col1 .vl-post-metas' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Side Post Meta Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .col2 .vl-post-metas' => 'color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_three';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_three');
