...
namespace Viral_Pro_Elements\Modules\NewsModuleSeventeen\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleSeventeen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 17', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-seventeen vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-news-block-alt .vl-small-block .vl-post-thumb' => 'width: {{SIZE}}{{UNIT}}',
                '{{WRAPPER}} .vl-news-block-alt .vl-small-block .vl-post-content' => 'margin-left: calc({{SIZE}}{{UNIT}} + 20px)',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-news-block-alt .vl-small-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-post-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-post-title:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-post-title' => 'color: {{VALUE}}',
            ],
                ]
        );

        $this->add_control(
                'listing_title_hover_color', [
            'label' => esc_html__('Title Color (Hover)', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-post-title:hover' => 'color: {{VALUE}}',
            ],
                ]
        );

        $this->add_control(
                'listing_post_title_margin', [
            'label' => esc_html__('Margin', 'viral-pro'),
            'type' => Controls_Manager::DIMENSIONS,
            'allowed_dimensions' => 'vertical',
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-post-metas' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-post-metas' => 'color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_seventeen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_seventeen');
