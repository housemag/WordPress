...
namespace Viral_Pro_Elements\Modules\SliderModuleFour\Widgets;
 ...
 * Tiled Posts Widget
 */
class SliderModuleFour extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Slider Module 4', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-slider-module-four vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style4 .slide-item h3 a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style4 .slide-item h3 a:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-slider-block.style4 .slide-item h3 a',
                ]
        );
        ...
        $this->start_controls_section(
                'additional_style', [
            'label' => esc_html__('Content Background', 'viral-pro'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-title-wrap' => 'background-color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        ?>
        <div class="vl-slider-block vl-ele-slider-block style4">
