...
namespace Viral_Pro_Elements\Modules\NewsModuleFourteen\Widgets;
...
class NewsModuleFourteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 14', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-twentytwo vp-elementor-icon';
    }
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_fourteen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_fourteen');
