...
namespace Viral_Pro_Elements\Modules\NewsModuleTwentythree\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleTwentythree extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 23', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-fifteen vp-elementor-icon';
    }
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_twentythree';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_twentythree');
