...
namespace Viral_Pro_Elements\Modules\SliderModuleThree\Widgets;
 ...
 * Tiled Posts Widget
 */
class SliderModuleThree extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Slider Module 3', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-slider-module-three vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style3 .slide-item h3 a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-slider-block.style3 .slide-item h3 a:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-slider-block.style3 .slide-item h3 a',
                ]
        );
