...
namespace Viral_Pro_Elements\Modules\TileModuleEight\Widgets;
 ...
 * Tiled Posts Widget
 */
class TileModuleEight extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module 8', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-eight vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style8' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-left-col .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-right-col .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_eight';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_eight');
