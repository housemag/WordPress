...
namespace Viral_Pro_Elements\Modules\NewsModuleSix\Widgets;
...
class NewsModuleSix extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 6', 'viral-pro');
    }
    ...
    public function get_icon() {
        return 'vp-news-module-six vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-big-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Top Block Title Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Bottom Block Title Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Bottom Block Title Color (Hover)', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-small-block .vl-post-title:hover:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-big-block .vl-post-title a',
                ]
        );
        ...
        $this->start_controls_tab(
            ...
            'label' => __('Bottom Block', 'viral-pro'),
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-small-block .vl-post-title',
                ]
        );
        ...
        $this->add_control(
                'top_excerpt_color', [
            'label' => esc_html__('Top Block Excerpt Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
                'bottom_excerpt_color', [
            'label' => esc_html__('Bottom Block Excerpt Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Top Block Meta Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Bottom Block Meta Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
    ...
    protected function render() {
        ...
        $settings['posts_per_page'] = intval($settings['bottom_post_count']['size']) + 1;
        $settings['block_type'] = 'news_block_six';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_six');
