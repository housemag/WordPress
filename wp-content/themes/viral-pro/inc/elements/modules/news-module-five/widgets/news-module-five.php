...
namespace Viral_Pro_Elements\Modules\NewsModuleFive\Widgets;
...
class NewsModuleFive extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 5', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-five vp-elementor-icon';
    }
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_five';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_five');
