...
namespace Viral_Pro_Elements\Modules\NewsModuleNine\Widgets;
...
class NewsModuleNine extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 9', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-nine vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-three-column-block .vl-big-post-item .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Listing Block', 'viral-pro'),
                ]
        );
        ...
        $this->add_group_control(
            ...
            'exclude' => ['custom'],
            'include' => [],
            'default' => 'viral-pro-360x240',
                ]
        );

        $this->add_control(
                'listing_thumb_width', [
            'label' => esc_html__('Image Width(px)', 'viral-pro'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['px'],
            'range' => [
                'px' => [
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-three-column-block .vl-post-item .vl-post-thumb' => 'width: {{SIZE}}{{UNIT}}',
                '{{WRAPPER}} .vl-three-column-block .vl-post-item .vl-post-content' => 'margin-left: calc({{SIZE}}{{UNIT}} + 20px)',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-three-column-block .vl-post-item .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Featured Post Title Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-post-item .vl-post-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
                'listing_title_color', [
            'label' => esc_html__('Listing Post Title Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-item .vl-post-title' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Listing Post Title Color (Hover)', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-item .vl-post-title:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-big-post-item .vl-post-title span',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-big-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->start_controls_tab(
                'listing_title_tab', [
            'label' => __('Listing Post', 'viral-pro'),
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-post-item .vl-post-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Featured Post Excerpt Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-post-item .vl-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );

        $this->add_control(
                'listing_excerpt_color', [
            'label' => esc_html__('Listing Post Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-item .vl-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Featured Post Meta Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-big-post-item .vl-post-metas' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Listing Post Meta Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-item .vl-post-metas' => 'color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['posts_per_page'] = intval($settings['listing_post_count']['size']) + 1;
        $settings['block_type'] = 'news_block_nine';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_nine');
