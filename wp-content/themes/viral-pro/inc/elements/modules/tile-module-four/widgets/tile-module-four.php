...
namespace Viral_Pro_Elements\Modules\TileModuleFour\Widgets;
 ...
 * Tiled Posts Widget
 */
class TileModuleFour extends Widget_Base {

    /** Widget Name */
    public function get_name() {
        return 'vp-tile-module-four';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('Tile Module 4', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-four vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style4' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_four';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_four');
