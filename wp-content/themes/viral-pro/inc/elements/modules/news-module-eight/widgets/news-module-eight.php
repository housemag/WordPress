...
namespace Viral_Pro_Elements\Modules\NewsModuleEight\Widgets;
...
class NewsModuleEight extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 8', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-eight vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' =>
            '{{WRAPPER}} .vl-big-block .vl-post-title a'
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .vl-excerpt' => 'color: {{VALUE}}'],
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .vl-post-metas' => 'color: {{VALUE}}'],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_eight';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_eight');
