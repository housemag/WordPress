...
namespace Viral_Pro_Elements\Modules\NewsModuleSixteen\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleSixteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 16', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-sixteen vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-list-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-post-title a',
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_sixteen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_sixteen');
