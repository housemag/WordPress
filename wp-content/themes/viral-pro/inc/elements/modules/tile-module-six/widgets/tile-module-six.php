...
namespace Viral_Pro_Elements\Modules\TileModuleSix\Widgets;
 ...
 * Tiled Posts Widget
 */
class TileModuleSix extends Widget_Base {

    /** Widget Name */
    public function get_name() {
        return 'vp-tile-module-six';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('Tile Module 6', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-six vp-elementor-icon';
    }

    /** Category */
    public function get_categories() {
        return ['viral-pro-tile-elements'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'thumb_spaces', [
            'label' => __('Spaces Between Thumb', 'viral-pro'),
            'type' => Controls_Manager::SELECT,
            'multiple' => true,
            'options' => [
                'space-0' => __('No Spaces', 'viral-pro'),
        ...
        $this->add_control(
                'module_height', [
            'label' => esc_html__('Module Height (px)', 'viral-pro'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['px'],
            'range' => [
                'px' => [
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style6' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-left-col .vl-post-title span',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-left-col .vl-title-container h3.vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-right-col .vl-post-title span',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-right-col .vl-title-container h3.vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_six';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_six');
