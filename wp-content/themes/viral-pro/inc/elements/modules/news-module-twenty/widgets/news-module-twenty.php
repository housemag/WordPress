...
namespace Viral_Pro_Elements\Modules\NewsModuleTwenty\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleTwenty extends Widget_Base {

    /** Widget Name */
    public function get_name() {
        return 'vp-news-module-twenty';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('News Module 20', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-twenty vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-1-2-block .vl-big-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
                'listing_post_border_color', [
            'label' => esc_html__('Bottom Border Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-news-block.style14 .vl-1-2-block .vl-small-block .vl-post-item' => 'border-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-big-block .vl-post-title',
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_twenty';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_twenty');
