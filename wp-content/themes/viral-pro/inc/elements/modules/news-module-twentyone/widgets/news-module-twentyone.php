...
namespace Viral_Pro_Elements\Modules\NewsModuleTwentyone\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleTwentyone extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 21', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-twentyone vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-fwnews-block-style5 .col2 .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .col1 .vl-post-title',
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .col2 .vl-post-title',
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_twentyone';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_twentyone');
