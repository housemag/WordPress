...
namespace Viral_Pro_Elements\Modules\NewsModuleTwentyfour\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleTwentyfour extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 24', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-twentyfour vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-mininews-block.style2 .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_twentyfour';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_twentyfour');
