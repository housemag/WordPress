...
namespace Viral_Pro_Elements\Modules\NewsModuleTen\Widgets;
...
class NewsModuleTen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 10', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-ten vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-three-column-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['posts_per_page'] = intval($settings['listing_post_count']['size']);
        $settings['block_type'] = 'news_block_ten';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_ten');
