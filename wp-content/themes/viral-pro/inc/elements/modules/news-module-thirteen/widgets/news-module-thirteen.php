...
namespace Viral_Pro_Elements\Modules\NewsModuleThirteen\Widgets;
...
class NewsModuleThirteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 13', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-thirteen vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-thumb-container, {{WRAPPER}} .vl-alt-post-item .vl-post-content' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-content' => 'background-color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_thirteen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_thirteen');
