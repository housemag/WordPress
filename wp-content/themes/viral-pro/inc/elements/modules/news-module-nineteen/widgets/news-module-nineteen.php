...
namespace Viral_Pro_Elements\Modules\NewsModuleNineteen\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleNineteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 19', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-nineteen vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-grid-2-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_nineteen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_nineteen');
