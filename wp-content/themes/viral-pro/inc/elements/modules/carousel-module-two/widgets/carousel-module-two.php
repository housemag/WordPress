...
namespace Viral_Pro_Elements\Modules\CarouselModuleTwo\Widgets;
 ...
 * Tiled Posts Widget
 */
class CarouselModuleTwo extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Carousel Module 2', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-carousel-module-two vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-carousel-block.style2 .vl-carousel-heading h3 a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-carousel-block.style2 .vl-carousel-heading h3 a:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-carousel-block.style2 .vl-carousel-heading h3 a',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-carousel-block.style2 .vl-carousel-heading h3 a' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        <div class="vl-carousel-block style2 <?php echo esc_attr($settings['image_hover_style']); ?>">
