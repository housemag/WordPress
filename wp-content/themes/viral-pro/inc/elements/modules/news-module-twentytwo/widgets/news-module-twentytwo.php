...
namespace Viral_Pro_Elements\Modules\NewsModuleTwentytwo\Widgets;
 ...
 * Tiled Posts Widget
 */
class NewsModuleTwentytwo extends Widget_Base {

    /** Widget Name */
    public function get_name() {
        return 'vp-news-module-twentytwo';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('News Module 22', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-fourteen vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Featured Excerpt Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Listing Excerpt Color', 'viral-pro'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
    ...
    protected function render() {
        ...
        $settings['posts_per_page'] = intval($settings['post_count']['size']);
        $settings['block_type'] = 'news_block_twentytwo';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_twentytwo');
