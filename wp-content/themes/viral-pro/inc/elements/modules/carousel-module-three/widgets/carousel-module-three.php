...
namespace Viral_Pro_Elements\Modules\CarouselModuleThree\Widgets;
 ...
 * Tiled Posts Widget
 */
class CarouselModuleThree extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Carousel Module 3', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-carousel-module-three vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-carousel-block.style3 .vl-carousel-heading h3 a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-carousel-block.style3 .vl-carousel-heading h3 a:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .vl-carousel-block.style3 .vl-carousel-heading h3',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-carousel-block.style3 .vl-carousel-heading h3' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        <div class="vl-carousel-block style3 <?php echo esc_attr($settings['image_hover_style']); ?>">
                        ...
                        while ($query->have_posts()): $query->the_post();
                            if (has_post_thumbnail()) {
                                ...
                                <div class="vl-carousel-item">
                                    <div class="vl-post-thumb vl-carousel-thumb">
