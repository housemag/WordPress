...
namespace Viral_Pro_Elements\Modules\TileModuleOne\Widgets;
...
class TileModuleOne extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Tile Module 1', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-tile-module-one vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'large_image_options', [
            'label' => __('Large Image', 'viral-pro'),
        ...
        $this->add_control(
                'small_image_options', [
            'label' => __('Small image', 'viral-pro'),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-tile-block.style1' => 'height: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'tile_block_one';
        $block = Viral_Pro_Blocks_Manager::get_instance('tile_block_one');
