...
namespace Viral_Pro_Elements\Modules\NewsModuleTwo\Widgets;
...
class NewsModuleTwo extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 2', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-two vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-fwnews-block-style2 .col1 .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-fwnews-block-style2 .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-content h3' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .vl-post-content h3:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .col1 .vl-post-item .vl-post-title a',
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'viral-pro'),
            'selector' => '{{WRAPPER}} .col2 .vl-post-item .vl-post-title a, 
                            {{WRAPPER}} .col3 .vl-post-item .vl-post-title a',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .col2 .vl-post-item .vl-post-title, 
                {{WRAPPER}} .col3 .vl-post-item .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_two';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_two');
