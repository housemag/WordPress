...
namespace Viral_Pro_Elements\Modules\NewsModuleEleven\Widgets;
...
class NewsModuleEleven extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 11', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-eleven vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-grid-block .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .vl-grid-blocks .vl-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['block_type'] = 'news_block_eleven';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_eleven');
