...
namespace Viral_Pro_Elements\Modules\NewsModuleFifteen\Widgets;
...
class NewsModuleFifteen extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Module 15', 'viral-pro');
    }

    /** Icon */
    public function get_icon() {
        return 'vp-news-module-twentythree vp-elementor-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-mininews-block.style1 .vl-post-thumb' => 'width: {{SIZE}}{{UNIT}}',
                '{{WRAPPER}} .vl-mininews-block.style1 .vl-post-content' => 'margin-left: calc({{SIZE}}{{UNIT}} + 20px)',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .vl-mininews-block.style1 .vl-thumb-container' => 'padding-bottom: {{SIZE}}{{UNIT}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $settings['posts_per_page'] = $settings['no_of_posts'];
        $settings['block_type'] = 'news_block_fifteen';
        $block = Viral_Pro_Blocks_Manager::get_instance('news_block_fifteen');
