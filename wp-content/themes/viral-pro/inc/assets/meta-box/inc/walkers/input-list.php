...
class RWMB_Walker_Input_List extends RWMB_Walker_Base {
    ...
    public function start_el(&$output, $object, $depth = 0, $args = array(), $current_object_id = 0) {
        ...
        $output .= sprintf(
                '<li><label><input %s %s>%s</label>', RWMB_Field::render_attributes($attributes), checked(in_array($object->value, $this->meta), true, false), RWMB_Field::filter('choice_label', $object->label, $this->field, $object)
        );
    }
