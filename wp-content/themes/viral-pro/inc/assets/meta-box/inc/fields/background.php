    ...
    public static function html($meta, $field) {
        ...
        $image = RWMB_File_Input_Field::normalize(
                        array(
                            ...
                            'placeholder' => __('Background Image', 'viral-pro'),
                        )
        );
        ...
        $repeat = RWMB_Select_Field::normalize(
                        array(
                            ...
                            'options' => array(
                                ...
                                'inherit' => esc_html__('Inherit', 'viral-pro'),
                            ),
                        )
        );
        ...
        $position = RWMB_Select_Field::normalize(
                        array(
                            ...
                            'options' => array(
                                'top left' => esc_html__('Top Left', 'viral-pro'),
                                'top center' => esc_html__('Top Center', 'viral-pro'),
                                'top right' => esc_html__('Top Right', 'viral-pro'),
                                'center left' => esc_html__('Center Left', 'viral-pro'),
                                'center center' => esc_html__('Center Center', 'viral-pro'),
                                'center right' => esc_html__('Center Right', 'viral-pro'),
                                'bottom left' => esc_html__('Bottom Left', 'viral-pro'),
                                'bottom center' => esc_html__('Bottom Center', 'viral-pro'),
                                'bottom right' => esc_html__('Bottom Right', 'viral-pro'),
                            ),
                        )
        );
