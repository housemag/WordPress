...
class RWMB_Select_Field extends RWMB_Choice_Field {
    ...
    public static function html($meta, $field) {
        ...
        $output = sprintf(
                '<select %s>', self::render_attributes($attributes)
        );
    ...
    public static function get_select_all_html($field) {
        if ($field['multiple'] && $field['select_all_none']) {
            return '<div class="rwmb-select-all-none">' . __('Select', 'viral-pro') . ': <a data-type="all" href="#">' . __('All', 'viral-pro') . '</a> | <a data-type="none" href="#">' . __('None', 'viral-pro') . '</a></div>';
        }
        return '';
    }
