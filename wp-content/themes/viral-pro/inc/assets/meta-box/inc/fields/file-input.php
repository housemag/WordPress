...
class RWMB_File_Input_Field extends RWMB_Input_Field {
    ...
    public static function admin_enqueue_scripts() {
        ...
        RWMB_Helpers_Field::localize_script_once(
            ...
            'frameTitle' => esc_html__('Select File', 'viral-pro'),
                )
        );
    }
    ...
    public static function html($meta, $field) {
        ...
        return sprintf(
			...
			<a href="#" class="rwmb-file-input-remove button %s">%s</a>', self::render_attributes($attributes), esc_html__('Select', 'viral-pro'), $meta ? '' : 'hidden', esc_html__('Remove', 'viral-pro')
        );
    }
