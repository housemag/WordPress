...
class RWMB_Core {
    ...
    public function plugin_links($links) {
        $links[] = '<a href="https://docs.metabox.io">' . esc_html__('Docs', 'viral-pro') . '</a>';
        $links[] = '<a href="https://metabox.io/pricing/" style="color: #39b54a; font-weight: bold">' . esc_html__('Go Pro', 'viral-pro') . '</a>';
        return $links;
    }
