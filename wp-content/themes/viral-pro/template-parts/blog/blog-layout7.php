...
<article id="post-<?php the_ID(); ?>" <?php post_class(array('viral-pro-hentry', 'blog-layout7')); ?> <?php echo viral_pro_get_schema_attribute('article'); ?>>
    ...
    <div class="ht-post-wrapper ht-clearfix">
        <?php if ('post' == get_post_type() && ($viral_pro_blog_date || $viral_pro_blog_author || $viral_pro_blog_comment)) : ?>
            <div class="ht-post-info">
                ...
                $post_year = $viral_pro_is_updated_date ? get_the_modified_date('Y') : get_the_date('Y');
